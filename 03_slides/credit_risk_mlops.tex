...
\column{0.31\textwidth}
\centering\textbf{PR \#4}\\
\scriptsize Review screenshot requested\\[0.15cm]
\placeholder{PR \#4 screenshot}{0.39\textheight}
\end{columns}
\vspace{0.2cm}
\scriptsize Note: \#2 and \#3 are merged PRs. GitHub has no resolvable \#4 in this repository at generation time; this is intentionally a replaceable placeholder rather than fabricated evidence.
\end{frame}
